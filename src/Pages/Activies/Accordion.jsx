  ...
  return (
    <div className="flex gap-2 flex-col w-[300px]">
      <div className="w-96 p-1">
        <div className="w-80 h-36 bg-[rgb(255,255,255)] rounded-md mt-2">
          ...
          <div className="text-[14px] text-[rgb(220,53,75)] font-normal leading-[1.43] w-32 h-[32px] pt-1 pl-3 pr-1 pb-1 ml-5 mt-3 bg-[rgb(255,255,255)] border-[rgb(229,229,229)] border-[1px] border-solid">
            Multi Language
          </div>
        </div>
        <div className="w-80 h-72 bg-[rgb(255,255,255)]  rounded-md mt-4">
          <div className="flex justify-between">
            <h1 className=" text-[14px]  text-[rgb(51,51,51)] hover:text-[rgb(220,53,75)] font-normal leading-[1.43] pt-3 pl-9 cursor-pointer">
              Genres
            </h1>
          ...
          <div className="w-80 h-24 bg-[rgb(255,255,255)]  rounded-md mt-9">
            <div className="flex justify-between">
              <h1 className=" text-[14px]  text-[rgb(51,51,51)] hover:text-[rgb(220,53,75)] font-normal leading-[1.43] pt-3 pl-9 cursor-pointer">
                Format
              </h1>
          ...
          <div className="w-80 h-9 mt-9 border-[rgb(220,53,88)] border-[1px] border-solid text-[rgb(220,53,88)] text-center pt-1 bg-transparent cursor-pointer">
            Browse by Cinemas
          </div>
        </div>
      </div>
